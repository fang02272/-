...
# ============================================================
# v2.6 专项归一化测试集（71 条：繁体 23 / 缩写 16 / 同义 32）
# 每条：查询 → 期望触达的概念规范词
# ============================================================
...
SYNONYM_TESTS = [
    ...
    ("坡口角", "坡口角度"), ("熔透深度", "熔深"),
    # 新增（v2.6 同义词扩展 38 组）：
    ("对接接头", "对接"), ("搭接接头", "搭接"), ("角接接头", "角接"),
    ("T型接头", "T形接头"), ("电焊条", "焊条"), ("纯氩", "氩气"),
    ("焊炬", "焊枪"), ("翻转机", "变位机"), ("工业机器人", "机器人"),
    ("维氏硬度", "硬度检测"), ("夏比冲击", "冲击试验"), ("抗拉试验", "拉伸试验"),
    ("球墨铸铁", "铸铁"), ("铬钼钢", "耐热钢"), ("双相钢", "双相不锈钢"),
    ("ESW", "电渣焊"), ("烧穿", "塌陷"), ("运条方法", "运条"),
]
...
def test_normalization_trigger():
    """v2.6 专项归一化测试 — 繁体 23 / 缩写 16 / 同义 32，共 71 条"""
